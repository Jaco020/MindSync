...
<body class="flex min-h-screen overflow-x-hidden">
    ...
    <main class="flex-1 space-y-6 p-2 md:p-10 h-screen overflow-y-auto">
        ...
        <div class="gap-6 grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 min-h-60">
            <div class="bg-bg-tint p-6 rounded-xl text-center">
                <p class="font-semibold text-header-gray text-lg md:text-xl 2xl:text-2xl">Twój średni nastrój</p>
                <div class="mt-4 2xl:mt-10 font-bold text-accent text-4xl md:text-5xl 2xl:text-6xl">{{$avgMood}}</div>
            </div>
            <div class="bg-bg-tint p-6 rounded-xl text-center">
                <p class="font-semibold text-header-gray text-lg md:text-xl 2xl:text-2xl">Streak aktywnych dni</p>
                <div class="mt-4 2xl:mt-10 font-bold text-accent text-4xl md:text-5xl 2xl:text-6xl">-</div>
            </div>
            <div class="relative bg-bg-tint p-6 rounded-xl overflow-y-hidden text-center">
                <p class="font-semibold text-header-gray text-lg md:text-xl 2xl:text-2xl">Twoje wpisy</p>
                <div class="mt-4 2xl:mt-10 font-bold text-accent text-4xl md:text-5xl 2xl:text-6xl">{{$journalEntriesCount}}</div>
            ...
            <div class="bg-bg-tint p-6 rounded-xl text-center">
                <p class="font-semibold text-header-gray text-lg md:text-xl 2xl:text-2xl">Porada na dziś</p>
        ...
        <div class="gap-6 grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-4 min-h-100">
            <div class="lg:col-span-2 2xl:col-span-3 bg-bg-tint p-6 rounded-xl">
                <p class="mb-5 font-semibold text-header-gray text-lg md:text-xl 2xl:text-2xl text-center">Wykres nastroju z ostatnich 30 dni</p>
            ...
            <div class="gap-6 grid grid-rows-2 h-full">
                <a href="emotions_journal" class="block relative bg-bg-tint p-4 pr-8 md:pr-4 rounded-xl hover:ring-2 hover:ring-accent transition duration-300 cursor-pointer">
                    <h3 class="mb-2 text-lg md:text-xl 2xl:text-2xl">Twój ostatni wpis</h3>
                ...
                <a href="/mind_exercises" class="block relative bg-bg-tint p-4 pr-8 md:pr-4 rounded-xl hover:ring-2 hover:ring-accent transition duration-300 cursor-pointer">
                    <h3 class="mb-2 text-lg md:text-xl 2xl:text-2xl">Polecane ćwiczenie</h3>
                    <p class="text-xs md:text-sm text-accent-strong">2h Spacer - Łatwy</p>
                    <p class="mt-2 text-gray-400 text-xs md:text-sm">Opis ćwiczenia Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                    <i class="fa-chevron-right right-4 bottom-4 absolute text-accent text-2xl md:text-3xl fa-solid"></i>
                </a>
            </div>
        </div>
